// Link do Video; https://youtu.be/CAqm5XR4ZSE
// Link do ColabEduc; http://www.colabeduc.org/projeto/show/1853
var bg0,
  bg3,
  Bbutton,
  circuloX,
...
function preload() {
  ...
  howto = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/howto.png"
  );
  bg3 = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/creditos.png"
  );
  Bbutton = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/stopbutton.png"
  );
  menubutton = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/menubutton.png"
  );
  telaf = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/telaf.png"
  );
  voltar = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/voltar.png"
  );
  menusong = loadSound(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/menusong.mp3"
  );
  soundFormats("mp3");
  som1 = loadSound(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/effect0.mp3"
  );
  levelsong = loadSound(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/levelsong.mp3"
  );
  perdeu = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/PERDEU.png"
  );
  venceu = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/GANHOU.png"
  );
  songwin = loadSound(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/yeee.mp3"
  );
  chave = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/chave.png"
  );
  estrela = loadImage(
    "https://raw.githubusercontent.com/elBLK/Arquivos/main/estrela.png"
  );
  sumario = loadImage(
...
function happyend() {
  ...
  if (contadorMortes <= 5) {
    ...
    fill("red");
    textSize(20);
    text(contadorMortes + " " + "Mortes", 308, 155);
    textSize(20);
